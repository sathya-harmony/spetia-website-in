            ...
            <div className="max-w-[1800px] mx-auto px-6 lg:px-12">
                ...
                <div className="py-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex gap-5 items-center">
                        ...
                        <a href="https://www.youtube.com/@SpetiaEngineering" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-spetia-orange-500 transition-colors" aria-label="YouTube">
